...
//	Count(collName string, query map[string]interface{}) (int, error)
//	FindWithLimit(collName, sortQuery string, limit int, query map[string]interface{}, doc interface{}) error
//	Update(collName string, selector map[string]interface{}, update interface{}) error
//	Upsert(collName string, selector map[string]interface{}, update interface{}) error
...
//func (m *MongoDAL) FindWithLimit(collName, sortQuery string, limit int, query map[string]interface{}, doc interface{}) error {
//	session := m.session.Clone()
//	defer session.Close()
...
//func (m *MongoDAL) FindOne(collName string, query map[string]interface{}, doc interface{}) error {
//	session := m.session.Clone()
//	defer session.Close()
...
//func (m *MongoDAL) Update(collName string, selector map[string]interface{}, update interface{}) error {
//	session := m.session.Clone()
//	defer session.Close()
...
//func (m *MongoDAL) Upsert(collName string, selector map[string]interface{}, update interface{}) error {
//	session := m.session.Clone()
//	defer session.Close()
...
//func (m *MongoDAL) Remove(collName string, selector map[string]interface{}) error {
//	session := m.session.Clone()
//	defer session.Close()
...
//func (m *MongoDAL) Count(collName string, query map[string]interface{}) (int64, error) {
//	session := m.session.Clone()
//	defer session.Close()
